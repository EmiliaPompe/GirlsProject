...
void logisticRegressionMH(double *restrict dataP, int *restrict data_lenP,  double *restrict sigma_matrixP, double *restrict mean_priorP, double *restrict sigma_priorP, int *restrict sP, double *restrict matrix_xP) // here we have matrix_x instead of vec
{
